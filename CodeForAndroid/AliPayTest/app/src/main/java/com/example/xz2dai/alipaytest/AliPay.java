...
public class AliPay {
    ...
    private static int SDK_AUTH_FLAG = 2;

    public AliPay(Context context){
        this.context =context;
        this.APPID = context.getString(R.string.APPID);
        this.RSA2_PRIVATE = context.getString(R.string.RSA2_PRIVATE);
        this.ALIPAY_PUBLIC_KEY = context.getString(R.string.ALIPAY_PUBLIC_KEY);
    }
            ...
            switch (msg.what) {
                case 1: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000")) {
                        ...
                        showAlert(context, context.getString(R.string.pay_success) + payResult);
                    } else {
                        // 该笔订单真实的支付结果，需要依赖服务端的异步通知。
                        showAlert(context, context.getString(R.string.pay_failed) + payResult);
                    }
                    break;
                }
                case 2: {
                    ...
                    if (TextUtils.equals(resultStatus, "9000") && TextUtils.equals(authResult.getResultCode(), "200")) {
                        ...
                        // 传入，则支付账户为该授权账户
                        showAlert(context, context.getString(R.string.auth_success) + authResult);
                    } else {
                        // 其他状态值则为授权失败
                        showAlert(context, context.getString(R.string.auth_failed) + authResult);
                    }
                    break;
                }
                default:
    ...
    public void payV2(String Price) {
        ...
        Map<String, String> params = buildOrderParamMap(APPID, rsa2 ,Price);
